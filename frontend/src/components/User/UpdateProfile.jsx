...
const UpdateProfile = () => {
    ...
    return (
        <>
            <MetaData title="Update Profile | Ferreteria Pitty" />
            ...
            <main className="w-full mt-12 sm:pt-20 sm:mt-0">
                ...
                <div className="flex sm:w-4/6 sm:mt-4 m-auto mb-7 bg-white shadow-lg">
                    {/* <!-- sidebar column  --> */}
                    <div className="loginSidebar bg-black px-9 py-10 hidden sm:flex flex-col gap-4 w-2/5">
                    ...
                    <div className="flex-1 overflow-hidden">
                        ...
                        >
                            <div className="flex flex-col gap-4 items-start">
                                ...
                                <button type="submit" className="text-white py-3 w-full bg-black shadow rounded-sm font-medium hover:shadow-lg">Update</button>
