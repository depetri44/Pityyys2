    ...
    const navs = [
        {
            ...
            redirect: "https://www.Ferreteria Pitty.com/communication-preferences/push",
        },
        {
            title: "Sell on Ferreteria Pitty",
            icon: <BusinessCenterIcon sx={{ fontSize: "18px" }} />,
            redirect: "https://seller.Ferreteria Pitty.com/sell-online",
        },
        {
            title: "24x7 Customer Care",
            icon: <LiveHelpIcon sx={{ fontSize: "18px" }} />,
            redirect: "https://www.Ferreteria Pitty.com/helpcentre",
        },
        {
            title: "Advertise",
            icon: <TrendingUpIcon sx={{ fontSize: "18px" }} />,
            redirect: "https://advertising.Ferreteria Pitty.com",
        },
        {
            title: "Download App",
            icon: <DownloadIcon sx={{ fontSize: "18px" }} />,
            redirect: "https://www.Ferreteria Pitty.com/mobile-apps",
        },
    ]
